			...
			do {
				...
				if (line.length() == 1) // check if a user entered only one character
				{
					...
					case 'D':
						...
						/************************************************************************************
						 *** Complete the follwing statement, if the company with above name and address
						 * is found show companyName + " at " + address + " is found\n"; otherwise show
					...
					case 'E':
						...
						state = stdin.readLine().trim();
						/************************************************************************************
						 *** Complete the follwing statement, if the company with above street, city,
						 * state info. is found show "Address: " + street + ", " + city + ", " + state +
						 * " is found\n"; otherwise show "Address: " + street + ", " + city + ", " +
						 * state + " is NOT found\n"
						 ***********************************************************************************/
					...
					case 'R':
						...
						/************************************************************************************
						 *** Complete the follwing statement, if the company with above name and address
						 * is found remove it and show companyName + " at " + address + " is removed\n";
						 * otherwise show companyName + " at " + address + " is NOT removed\n"
						 ***********************************************************************************/
					...
					case 'W':
						...
						try {
							/************************************************************************************
							 *** Complete the follwing statement, write object companyManage1 inside the data
							 * file
							 ***********************************************************************************/
					...
					case 'X':
						...
						try {
							/************************************************************************************
							 *** Complete the follwing statement, read object from the data file and save the
							 * object as companyManage1
							 ***********************************************************************************/
